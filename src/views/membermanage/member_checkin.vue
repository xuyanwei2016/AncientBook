  ...
  <div class="app-container xyw">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" style="width:100%">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="form-submit" @click="signSetting" :disabled="sending">保存</el-button>
      ...
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          updateSignAPI(tempData).then(res => {
            operationMsg.apply(this,[res.data,'签到设置'])
    ...
    deleteAll(){
      confirm.apply(this,['确定清空所有会员签到记录吗？']).then(() => {
        deleteAllAPI().then(res => {
          operationMsg.apply(this,[res.data,'清空所有会员签到记录'])
        }) 
      })
    }
  }
