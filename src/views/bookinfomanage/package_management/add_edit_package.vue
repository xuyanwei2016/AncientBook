  ...
  <div class="app-container">
    ...
    <el-form ref="dataForm" :rules="rules" :model="temp" label-position="right" label-width="120px"  class="double-column-form clearfix">
      ...
      <el-form-item label="图片集：" prop="picList" class="width100">
        <el-upload :action="`${domain}/zuul${requestPath.file}${uploadPath}`" list-type="picture-card" :file-list="temp.picList" :on-preview="handlePicPreview" :before-upload="beforePicUpload" :on-remove="handleRemove" :on-success="handleSuccess" :disabled="uploading">
      ...
      <el-form-item label="套餐视频：" prop="video" class="width100">
        <el-col :span="12">
          <el-upload class="video-uploader clearfix" :action="`${domain}/zuul${requestPath.file}${uploadPath}`" :show-file-list="false" :on-success="handleVideoSuccess" :before-upload="beforeVideoUpload">
    ...
    <section class="related-goods">
      <h3>套餐关联商品</h3>
      <div class="buttons" v-if="temp.pbook.realOrderCount===0">
    ...
    <el-dialog title="关联商品" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="selectSubmit" :loading="sending">确认</el-button>
...
import {bookCheckBookAPI} from '@/api/book-infomation/goodsInfo'
