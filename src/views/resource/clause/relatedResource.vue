...
<div class="app-container project-plan">
    ...
    <div class="table">
      ...
      >
        ...
        <template slot-scope="scope">
          ...
          <img v-if="scope.row.cover" :src="`${domain}${requestPath.file}?fileName=${scope.row.cover}&isOnLine=true`" class="imagesize">  
        </template>
        </el-table-column>
  ...
  <el-dialog title="关联内容" width="80%" :visible.sync="relatedDialog" class="backgroundDialog relatedDialog">
    <el-form inline :model="relatedForm" label-width="120">
        <el-form-item label="资源类型" style="margin-right:20px">
     ...
     <el-table
        ...
        <pagination style="background:#393f5b" class="dialog_prfooter" @pagesize="pagesizeFun2" :total="total2" @currentPage="currentPageFun2" ref="child"></pagination>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary"  @click="confirmRelated">确 定</el-button>
...
import { getRelatedList, saveRelatedAPI, delRelatedAPI } from "@/api/resource/clause";
import {
  operationMsg,
  requestMsg,
  errorMsg,
