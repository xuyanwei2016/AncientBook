...
<div class="app-container">
  ...
  <el-dialog title="关联内容" :visible.sync="relatedDialog" class="backgroundDialog relatedDialog">
    <el-form :model="relatedForm" label-width="82">
        <el-form-item label="资源类型" style="margin-right:20px" inline>
...
import { getRelatedList, saveRelatedAPI,delRelatedAPI } from "@/api/resource/patent";
import {
  operationMsg,
  requestMsg,
  errorMsg,
