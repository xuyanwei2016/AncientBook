<template>
  <div class="app-container project-plan">
    ...
    >
      <el-form :model="relatedForm" inline label-width="100">
        <el-form-item label="资源类型" style="margin-right:20px">
        ...
        <el-form-item prop="selfClass" label="选择分类" style="margin-right:20px;">
          <treeselect
...
import { getRelatedListAPI, getTypeAPI } from "@/api/resource/common";
export default {
