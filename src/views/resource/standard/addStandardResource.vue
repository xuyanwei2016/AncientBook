        ...
        <el-tab-pane label="资源信息" name="first" >
          <div class="tabwrapper">
            ...
            >
              ...
              <el-form-item label="标准号:" prop="criterionNum">
                <el-input v-model="resourceForm.criterionNum" class="width460"></el-input>
              </el-form-item>
              <el-form-item label="所属图书:" prop="bookName">
                <el-input v-model="resourceForm.bookName" class="width460"></el-input>
              </el-form-item>
              <el-form-item label="标准状态:" prop="criterionStatus">
                <el-input v-model="resourceForm.criterionStatus" class="width460" placeholder="请输入数字"></el-input>
              </el-form-item>
              <el-form-item label="发布单位:" prop="issuingOrgan">
                <el-input v-model="resourceForm.issuingOrgan" class="width460"></el-input>
              </el-form-item>
              <el-form-item label="发布日期:" prop="issuingTime">
                <el-date-picker
                  v-model="resourceForm.issuingTime"
                  type="date"
                  class="width460"
                  placeholder="选择日期">
                </el-date-picker>
                <!-- <el-input v-model="resourceForm.issuingTime" class="width460"></el-input> -->
              </el-form-item>
              <el-form-item label="起草单位:" prop="draftOrgan">
                <el-input v-model="resourceForm.draftOrgan" class="width460"></el-input>
              </el-form-item>
              <el-form-item label="实施日期:" prop="agency">  
                <el-date-picker
                  v-model="resourceForm.agency"
                  type="date"
                  class="width460"
                  placeholder="选择日期">
                </el-date-picker>
              ...
              <el-form-item label="出版单位:" prop="publisher">
                <el-input v-model="resourceForm.publisher" class="width460"></el-input>
              </el-form-item>
              <el-form-item label="主要起草人:" prop="draftPeople">
                <el-input v-model="resourceForm.draftPeople" class="width460"></el-input>
              </el-form-item>
              ...
              <el-form-item label="自定义分类:">
                <treeselect
                  v-model="resourceForm.treeSelectValue"
                  :multiple="true"
              ...
              <el-form-item label="自定义标签:" prop="CustomTag">
                <el-input type="textarea" v-model='resourceForm.CustomTag' class="width460"></el-input>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [{ required: true, message: "标准名称为必填", trigger: "blur" }],
        criterionNum:[{ required: true, message:'标准号为必填', trigger:'blur' }],
        bookName:[{ required: true, message: '所属图书为必填',trigger:'blur' }],
        criterionStatus:[{ required: true, message: '标准状态为必填',trigger:'blur' }],
        issuingOrgan:[{ required: true, message: '发布单位为必填',trigger:'blur' }],
        issuingTime:[{ required: true, message: '发布日期为必填',trigger:'blur' }],
        draftOrgan:[{ required: true, message: '起草单位为必填',trigger:'blur' }],
        agency:[{ required: true, message: '实施日期为必填',trigger:'blur' }],
        publisher:[{ required: true, message: '出版单位为必填',trigger:'blur' }],
        draftPeople:[{ required: true, message: '主要起草人为必填',trigger:'blur' }],
  ...
  methods: {
    ...
    selectFun(node) { 
      ...
      console.log(this.resourceForm.diyTypeId,this.resourceForm.diyTypeCode)
    },
    deselectFun(node) {
        ...
        if (valid) {
          ...
          if (id) { //如果ID存在说明就是在修改已有的数据，否则就是下面的新增
            ...
            addAPI(this.resourceForm).then(res => {
              console.log(res,'kkk')
              console.log(this.resourceForm,'hhh')
              console.log(res.data.code,'yyy')
              if (res.data.code === 0) {
                this.$message.success("添加成功");
                // this.activeName = "second";
                // this.$router.push({path: '/resource/standard'})
                this.$router.go(-1);
              } else {
                this.$message.error("添加失败");
              }
