<template>
  <div class="app-container project-plan">
    ...
    <!--关联内容-->
    <el-dialog title="关联内容" :visible.sync="relatedDialog" width="80%" class="backgroundDialog relatedDialog">
      <el-form :model="relatedForm" label-width="82px" inline class="formlist">
        ...
        <el-form-item prop="selfClass" label="选择分类:" style="width: 300px;">
          <treeselect
        ...
        <el-button type="primary" @click="searchRelated">检索</el-button>
      </el-form>
      <el-table
        border
