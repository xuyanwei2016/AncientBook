  ...
  <div class="app-container">
    <el-form class="form-container" :model="postForm" :rules="rules" ref="postForm">
      ...
      <div class="createPost-main-container">
        <el-row>
          <el-col :span="12">
            <el-form-item style="margin-bottom: 40px;" label-width="100px" label="公告标题：">
                <el-input type="input" placeholder="请输入内容" v-model="postForm.title" clearable>
                </el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item style="margin-bottom: 40px;" label-width="100px" label="来源：">
                <el-input type="input" placeholder="请输入内容" v-model="postForm.source" clearable>
                </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item style="margin-bottom: 40px;" label-width="100px" label="作者：">
                <el-input type="input" placeholder="请输入内容" v-model="postForm.creater" clearable>
                </el-input>
            </el-form-item>
          </el-col>
        </el-row>
