<template>
  ...
  <div class="app-container">
    ...
    <div class="print-content">
      ...
      <p style="text-align: right;margin-right: 0px; color:#333; font-size: 12px;">订单编号：{{orderDetail.orderCode}}</p>
      ...
      <p style="text-align:right;font-size: 12px;font-weight: normal;color: #333">共  <span
        style="color:red;font-size:14px">{{bookNum}}</span>
        件商品,商品金额  <span style="color:red;font-size:14px">{{subtotal}}</span> 元,运费  <span
          style="color:red;font-size:14px">{{orderDetail.carriage}}</span>
        元,订单金额  <span
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doPrint() {
        if(this.isDoPrintBtn){
          this.isDoPrintBtn=false;
          window.print()
          this.isDoPrintBtn=true;
        }
      }
    }
  }
