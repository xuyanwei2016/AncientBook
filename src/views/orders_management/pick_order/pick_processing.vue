<template>
  <div class="app-container">
    ...
    <el-form ref="orderForm" :model="orderDetail" label-position="right" label-width="120px" class="order-form clearfix">
      ...
      <el-form-item label="读者运费：">{{orderDetail.realReaderCarriage}}</el-form-item>
    ...
    <el-form ref="logisticsForm" :model="orderDetail" label-position="right" label-width="120px" class="order-form clearfix">
      <el-form-item label="物流公司：">{{orderDetail.distributionModeName}}</el-form-item>
    ...
    <p class="divider"></p>
      ...
      <p style="text-align:right">商品总金额 <span style="color:red;font-size:20px">{{subtotal}}</span> 元,运费<span style="color:red;font-size:20px">{{orderDetail.realReaderCarriage}}</span> 元,订单总金额<span style="color:red;font-size:20px">{{orderDetail.sumPrice}}</span> 元</p>
