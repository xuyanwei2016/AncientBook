<template>
  <div class="app-container">
    ...
    <el-form inline>
      ...
      <el-form-item>
        <el-button @click="handleFilter" icon="el-icon-search">检索</el-button><el-button @click="resetFilter">重置</el-button>
      </el-form-item>
    </el-form>
    ...
    setTopStatus(status){
      if (this.multipleSelection.length>0) {
        ...
        topStatusAPI(this.batchData).then(res => {
          status===0 ? operationMsg.apply(this,[res.data,`取消置顶${len}项`]) : operationMsg.apply(this,[res.data,`置顶${len}项`])
        })
      } else {
